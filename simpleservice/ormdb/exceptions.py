...
import six
from simpleutil.utils.reflection import removed_property
...
class DBInvalidUnicodeParameter(Exception):
    ...
    def __init__(self):
        super(DBInvalidUnicodeParameter, self).__init__("Invalid Parameter: Encoding directive wasn't provided.")
